...
namespace mcx.Utilities.Audio
{
    ...
    public class ClipDefinition
    {
        ...
        /// <summary>
        /// Gets or sets the name of the audio file for this clip, including the file extension.
        /// </summary>
        [Description("Sets the name of the audio file for this clip (including file extension).")]
