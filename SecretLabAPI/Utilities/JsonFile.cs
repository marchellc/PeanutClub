        ...
        public static T ReadFile<T>(string filePath, T? defaultValue = default)
        {
            ...
            else
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ApiLog.Error("JsonFile", $"Failed to read JSON file at &3{filePath}&3. The original file has been renamed to &3{filePath}.error&r. A new default file has been created. Exception:\n{ex}");
                    return defaultValue!;
                }
            }
        }
