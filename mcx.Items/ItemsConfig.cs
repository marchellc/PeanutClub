...
using mcx.Items.Weapons;
using mcx.Items.Weapons.ItemLauncher;
...
public class ItemsConfig
{
    ...
    /// <summary>
    /// The list of item launchers and their properties.
    /// </summary>
    [Description("Sets the list of item launchers and their properties.")]
    public Dictionary<string, ItemLauncher> ItemLaunchers { get; set; } = new()
    {
        ["ptc.itemlauncher"] = new()
    };
}